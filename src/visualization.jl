...
block_size_rows = 5
block_size_cols = 5
function visualization(model::Shape_Growth_Populate.CellModel{Dim}) where Dim 
    ...
    if Dim == 2 
        ...
        Shape_Growth_Populate.visualize_history_animation_2D(model, animation_filename_2D, block_size_rows, block_size_cols, 10) 
        ...
        Shape_Growth_Populate.visualize_history_3D_plotly_frames(model, Dim, output_dir_3D)
