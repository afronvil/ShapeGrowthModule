# ~/Nextcloud/Logiciels/Shape_Growth_Populate/src/visualization_2D.jl
...
"""
    visualize_final_state_2D(model::Shape_Growth_Populate.CellModel{2}, output_filename::String, block_size_rows::Int, block_size_cols::Int)
...
# Arguments
- `model::Shape_Growth_Populate.CellModel{2}`: L'instance du modèle de simulation (doit être de Dim=2).
...
"""
function visualize_final_state_2D(model::Shape_Growth_Populate.CellModel{2}, output_filename::String, block_size_rows::Int, block_size_cols::Int)
...
"""
    visualize_history_animation_2D(model::Shape_Growth_Populate.CellModel{2}, output_filename::String, block_size_rows::Int, block_size_cols::Int, fps::Int=10)
...
"""
function visualize_history_animation_2D(model::Shape_Growth_Populate.CellModel{2}, output_filename::String, block_size_rows::Int, block_size_cols::Int, fps::Int=10)
