...
@with_kw mutable struct StromalCell{Dim} 
    coordinates::NTuple{Dim, Int64} # Paramétré par Dim
    timer::Int64 = 0 # Example default
    cell_type::Int64 = 6 # This is now allowed!
    initial_stromal_cell_type::Int64 = 6 # Example default
...
struct SystemState{Dim}
    cells::Dict{NTuple{Dim, Int64}, Cell{Dim}}  
    stromal_cells::Union{Dict{NTuple{Dim, Int64}, StromalCell{Dim}}, Nothing}
    time::Float64
end
