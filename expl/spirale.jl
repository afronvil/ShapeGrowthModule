...
# fct1(cell::ShapeGrowthModels.Cell) = round(5 + 2 * sin(ShapeGrowthModels.angle(cell.coordinates) * 5 + ShapeGrowthModels.distance_from_center(cell.coordinates) * 0.2))
# fct2(cell::ShapeGrowthModels.Cell) = round(5 + 2 * cos(ShapeGrowthModels.angle(cell.coordinates) * 5 + ShapeGrowthModels.distance_from_center(cell.coordinates) * 0.2))
# fct3(cell::ShapeGrowthModels.Cell) = round(5 + 2 * sin(ShapeGrowthModels.angle(cell.coordinates) * 5 + ShapeGrowthModels.distance_from_center(cell.coordinates) * 0.2))
# fct4(cell::ShapeGrowthModels.Cell) = round(5 + 2 * cos(ShapeGrowthModels.angle(cell.coordinates) * 5 + ShapeGrowthModels.distance_from_center(cell.coordinates) * 0.2))
# fct5(cell::ShapeGrowthModels.Cell) = round(5 + 2 * sin(ShapeGrowthModels.angle(cell.coordinates) * 5 + ShapeGrowthModels.distance_from_center(cell.coordinates) * 0.2))
...
cell_type_sequence=[2, 3, 4, 5, 2, 3,  4, 5,2, 3,  4, 5,2, 3,  4, 5,2, 3,  4, 5] #,2, 3, 4,5]#, 1, 4, 5, 1, 2, 3, 4, 5] # Séquence de types incluant 5
